...
class LogCallback(TrainerCallback):
    ...
    def on_log(self, args: "TrainingArguments", state: "TrainerState", control: "TrainerControl", **kwargs):
        ...
        logs = dict(
            ...
            sft_loss=state.log_history[-1].get("sft_loss"),
            collapse_loss=state.log_history[-1].get("collapse_loss"),
            collapse_loss_ratio=state.log_history[-1].get("collapse_loss_ratio"),
            collapse_lambda1=state.log_history[-1].get("collapse_lambda1"),
            collapse_lambda2=state.log_history[-1].get("collapse_lambda2"),
            collapse_lambda1_grad_norm=state.log_history[-1].get("collapse_lambda1_grad_norm"),
            collapse_lambda2_grad_norm=state.log_history[-1].get("collapse_lambda2_grad_norm"),
            ...
            align_mask_t_mean=state.log_history[-1].get("align_mask_t_mean"),
            align_question_tokens=state.log_history[-1].get("align_question_tokens"),
            align_answer_tokens=state.log_history[-1].get("align_answer_tokens"),
            align_rank_layers=state.log_history[-1].get("align_rank_layers"),
            align_rank_question_loss=state.log_history[-1].get("align_rank_question_loss"),
            align_rank_answer_loss=state.log_history[-1].get("align_rank_answer_loss"),
            align_rank_question_gap=state.log_history[-1].get("align_rank_question_gap"),
            align_rank_answer_gap=state.log_history[-1].get("align_rank_answer_gap"),
            align_rank_question_top_score=state.log_history[-1].get("align_rank_question_top_score"),
            align_rank_question_other_score=state.log_history[-1].get("align_rank_question_other_score"),
            align_rank_answer_top_score=state.log_history[-1].get("align_rank_answer_top_score"),
            align_rank_answer_other_score=state.log_history[-1].get("align_rank_answer_other_score"),
            align_question_weight=state.log_history[-1].get("align_question_weight"),
            align_answer_weight=state.log_history[-1].get("align_answer_weight"),
            align_cluster_layers=state.log_history[-1].get("align_cluster_layers"),
            align_clusters_mean=state.log_history[-1].get("align_clusters_mean"),
            align_cluster_js_question=state.log_history[-1].get("align_cluster_js_question"),
            align_cluster_js_answer=state.log_history[-1].get("align_cluster_js_answer"),
            align_cluster_similarity_question=state.log_history[-1].get("align_cluster_similarity_question"),
            align_cluster_similarity_answer=state.log_history[-1].get("align_cluster_similarity_answer"),
